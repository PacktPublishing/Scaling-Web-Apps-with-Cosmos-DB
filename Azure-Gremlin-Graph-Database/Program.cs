...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "https://graphapidemo11.documents.azure.com";
        private static int port = 443;
        private static string authKey = "CYeTdt6MePnt2aOsFP7BhsT6ZdSCD7ZdScp5l5D9zjjqTjpvfcnbJqGILz8cF3GdhWfRi4ZNcyDpOvAMAd9n0g==";
        ...
        static void Main(string[] args)
        {
            var gremlinServer = new GremlinServer(hostname, port, enableSsl: true, 
                                                    username: "graphdb1" + database + "Persons" + collection, 
                                                    password: authKey);
