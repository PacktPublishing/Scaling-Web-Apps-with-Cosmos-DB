...
namespace CassandraQuickStartSample
{
    public class Program
    {
        ...
        private const string UserName = "cassandradb"; 
        private const string Password = "Az8OWuaNFANDtsE7XFDu4nQKuRPTcX6kvjnPoRRUBTaz6Hsb9lNtVSfEWrXvNI8ZEv8zY0hd67POkbr08He6tQ==";
        private const string CassandraContactPoint = "cassandradb.cassandra.cosmosdb.azure.com";  // DnsName  
